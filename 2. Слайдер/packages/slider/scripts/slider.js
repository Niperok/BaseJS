...
let images = {
    ...
    getInLeftAnimation() {
        this.slides[this.currentIdx].classList.add('animate__slideInRight');
    },

    getOutLeftAnimation() {
        this.slides[this.currentIdx].classList.add('animate__slideOutLeft');
    },

    getInRightAnimation() {
        this.slides[this.currentIdx].classList.add('animate__slideInLeft');
    },

    getOutRightAnimation() {
        this.slides[this.currentIdx].classList.add('animate__slideOutRight');
    },

    removeAnimations() {
        this.slides[this.currentIdx].classList.remove('animate__slideInRight');
        this.slides[this.currentIdx].classList.remove('animate__slideOutLeft');
        this.slides[this.currentIdx].classList.remove('animate__slideInLeft');
        this.slides[this.currentIdx].classList.remove('animate__slideOutRight');
    },

    /** Переключиться на предыдущее изображение. */
    setNextLeftImage() {
        this.getOutLeftAnimation();
        ...
        this.getInLeftAnimation();
        this.showImageWithCurrentIdx();
    },

    /** Переключиться на следующее изображение. */
    setNextRightImage() {
        this.getOutRightAnimation();
        //this.hideVisibleImages();
